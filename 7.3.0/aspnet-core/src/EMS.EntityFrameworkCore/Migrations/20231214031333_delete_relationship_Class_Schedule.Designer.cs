...
namespace EMS.Migrations
{
    ...
    [Migration("20231214031333_delete_relationship_Class_Schedule")]
    partial class delete_relationship_Class_Schedule
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EMS.Authorization.Schedules.Schedule", b =>
                {
                    ...
                    b.ToTable("AbpSchedule");
                });

            modelBuilder.Entity("EMS.Authorization.Teachers.Teacher", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("AbpTeacher");
                });

            modelBuilder.Entity("EMS.Authorization.TrackingClasses.TrackingClass", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("AbpTrackingClass");
                });

            modelBuilder.Entity("EMS.Authorization.TuitionFees.TuitionFee", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EMS.ClassTimelines.ClassTimeline", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("AbpClassTimeline");
                });

            modelBuilder.Entity("EMS.Homeworks.Homework", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("AbpHomeworks");
                });

            modelBuilder.Entity("EMS.Homeworks.SubmitHomeWork", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EMS.Social.Comments.Comment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("AbpComments");
                });

            modelBuilder.Entity("EMS.Social.Posts.Post", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EMS.Authorization.Classes.Class", b =>
                {
                    b.HasOne("EMS.Authorization.Courses.Course", "Course")
                        .WithMany("Classes")
            ...
            modelBuilder.Entity("EMS.ClassTimelines.ClassTimeline", b =>
                {
                    ...
                    b.HasOne("EMS.Authorization.Schedules.Schedule", "Schedule")
                        .WithMany()
            ...
            modelBuilder.Entity("EMS.Homeworks.Homework", b =>
                {
                    b.HasOne("EMS.Social.Posts.Post", "Post")
                        .WithOne("Homework")
                        .HasForeignKey("EMS.Homeworks.Homework", "PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EMS.Homeworks.SubmitHomeWork", b =>
                {
                    b.HasOne("EMS.Homeworks.Homework", "Homework")
                        .WithMany()
